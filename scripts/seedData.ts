...
export const STYLES: SeedStyle[] = [
  ...
  },
  {
    ...
    description:
      "A single-strap leather slide on a molded EVA footbed — the lowest-MOQ style in the line, built for accounts testing sell-through before committing to a deeper buy.",
