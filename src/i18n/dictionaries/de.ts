...
const de: Dictionary = {
  ...
  box: {
    fixed: "Feste Vorpack-Kartons — keine Einzelgrößen",
  ...
  stock: {
    live: "Für Ihre Bestellung gefertigt — Lieferung in etwa {days} Tagen",
  },
  rep: {
    assigned: "Ein fester Ansprechpartner für jedes freigegebene Konto",
  },
  pricing: {
  ...
  orderDetail: {
    ...
    dashboard: "Dashboard",
    proformaNotice: "Anfrage erhalten — das ist keine Belastung. Wir prüfen die Produktion für diese Mengen und senden Ihnen die Rechnung mit Endpreis, Liefertermin und Zahlungsdaten, meist innerhalb eines Werktags.",
  ...
  apply: {
    ...
    countryHint: "Wo Ihr Unternehmen registriert ist. Käufer außerhalb Griechenlands erhalten Rechnungen ohne griechische MwSt.",
  ...
  actions: {
    ...
    applicationAlreadyReceived: "Von dieser E-Mail-Adresse liegt bereits ein Antrag vor — wir melden uns bald. Fragen? Schreiben Sie an info@hectorfootwear.gr.",
    activationFailed:
  ...
  pdf: {
    ...
    statusShipped: "An Spediteur übergeben",
    ...
    subtotal: "Zwischensumme",
    vat: "MwSt.",
    vatZeroAbroad: "MwSt. 0 % — Käufer mit Sitz außerhalb Griechenlands",
    grandTotal: "Gesamt",
    inStock: "Auf Lager",
    production: "In Produktion",
    eta: "Liefertermin",
    ...
    proformaNotice: "Diese Proforma ist keine Belastung. Wir bestätigen Mengen, Endpreis und Liefertermin und senden Ihnen dann die Rechnung mit unseren Zahlungsdaten.",
    invoiceFooter:
  ...
  email: {
    ...
    statusBodyConfirmed: "Ihre Bestellung {id} ist bestätigt. Die Rechnung mit Endpreis, Liefertermin und Zahlungsdaten ist unterwegs.",
    statusBodyInProduction: "Ihre Bestellung {id} ist jetzt in Produktion. Wir rechnen mit Fertigstellung um den {date}.",
    statusBodyShipped: "Ihre Bestellung {id} ist fertig und wurde Ihrem Spediteur übergeben.",
    statusBodyDelivered: "Ihre Bestellung {id} wurde geliefert. Vielen Dank — gute Verkäufe!",
    statusBodyCancelled: "Ihre Bestellung {id} wurde storniert. Fragen? Antworten Sie auf diese E-Mail oder schreiben Sie uns per WhatsApp.",
    viewOrderLine: "Ihre Bestellung: {link}",

    orderConfirmationSubject: "Auftragsbestätigung — {id}",
    orderConfirmationBody: "Wir haben Ihre Bestellanfrage {id} erhalten. Wir prüfen die Produktion für diese Mengen und senden Ihnen die Rechnung mit Endpreis, Liefertermin und Zahlungsdaten — meist innerhalb eines Werktags.",
    ...
    madeToOrderNote: "Ihre Paare werden für diese Bestellung gefertigt — die Lieferung erfolgt in der Regel etwa {days} Tage nach unserer Bestätigung.",
    preOrderNote:
    ...
    inviteSubject: "Ihr Hector Footwear Großhandelskonto ist bereit",
    inviteBody: "Wir haben für {business} ein Großhandelskonto auf unserer neuen Bestellseite eingerichtet. Legen Sie über den Link unten Ihr Passwort fest, um Ihre Preise zu sehen und jederzeit zu bestellen — kartonweise, vom Handy oder Computer.",
    inviteWhatsapp: "Hallo {name}, wir haben für {business} ein Großhandelskonto auf unserer neuen Seite eingerichtet. Passwort hier festlegen, Preise sehen und online bestellen: {link} — Hector Footwear",
    seasonSubject: "Neue Modelle — bis {orderBy} bestellen, Lieferung um den {deliveredBy}",
    seasonIntro: "Unsere neuesten Modelle sind im Katalog und bestellbar:",
    seasonDeadline: "Bestellen Sie bis {orderBy}, dann sind Ihre Kartons um den {deliveredBy} fertig.",
    seasonCtaNew: "Neue Modelle ansehen",
    seasonCtaSheet: "Bestellliste öffnen",
  ...
  dashboard: {
    ...
    quickOrderIntro: "Alle Modelle auf einer Liste. Anzahl Kartons eintippen, Tab drücken — sie landen direkt im Warenkorb. Preise gelten für die gewählten Zahlungsbedingungen.",
    remove: "Entfernen",
    ...
    thLineTotal: "Summe",
    thArrives: "Lieferung",
    inStock5Days: "in 5 Tagen",
    boxesPairs: "{boxes} Kartons · {pairs} Paar",
    sheetSubtotalVat: "Zwischensumme {subtotal} + MwSt. {vat}",
    sheetTotal: "Gesamt {total}",
    pasteTitle: "Bestellung einfügen",
    pasteHelp: "Eine Zeile pro Modell: Nummer, Farbe, Anzahl Kartons — z. B. „5109 brown 3“. Zeilen aus Excel, E-Mail oder WhatsApp gehen auch.",
    pasteAdd: "In den Warenkorb",
    pasteAdded: "{count} Zeilen zum Warenkorb hinzugefügt.",
    pasteUnmatched: "Nicht erkannt — Nummer prüfen oder Farbe ergänzen:",
    boxQtyAria: "Kartons {name}, {colour}",
    ...
    journeyTitle: "Wie es weitergeht",
    journeyRequest: "Anfrage gesendet",
    journeyRequestNote: "Noch keine Belastung",
    journeyConfirm: "Bestätigt & in Rechnung gestellt",
    journeyConfirmNote: "Innerhalb 1 Werktags — Endpreis, Termin, Zahlungsdaten",
    journeyProduction: "In Produktion",
    journeyProductionNote: "Etwa {days} Tage",
    journeyShipped: "An Ihren Spediteur übergeben",
    journeyShippedNote: "Um den {date}",
    journeyDelivered: "Geliefert",
    journeyCancelled: "Diese Bestellung wurde storniert.",
  ...
  catalog: {
    ...
    preOrderShips: "Vorbestellung — für Sie gefertigt, Lieferung in etwa {days} Tagen",
    madeToOrderShips: "Auf Bestellung — für Sie gefertigt, Lieferung in etwa {days} Tagen",
    ...
    publicPanelBody: "Händlerpreise sehen freigegebene Großhandelskonten. Jede Bestellung wird für Sie gefertigt und in etwa {days} Tagen geliefert. Anträge prüft ein Mensch, in der Regel innerhalb von zwei Werktagen.",
    ...
    band40to50: "40–50 €",
    band50up: "Ab 50 €",
    arrivesAround: "Lieferung um den {date}",
    arrivesAroundToday: "Lieferung um den {date} bei Bestellung heute",
    inStockShips: "Auf Lager — Versand in 5 Tagen",
    perPairLabel: "Pro Paar",
    boxOfLabel: "Karton à {pairs}",
    rrpLabel: "UVP",
    markupLabel: "Kalkulation",
    colourCount: "{count} Farben",
    emptyTitle: "Keine Modelle für diesen Filter",
    emptyBody: "{count} Modelle sind verfügbar — diese Kombination passt nur auf keines.",
    browseLinesheet: "Bestellliste öffnen",
    grpBox: "Kartongröße",
    boxFilterOption: "Karton à {pairs} Paar",
    inCartCount: "{count} im Warenkorb",
    boxesAvailable: "{count} Kartons auf Lager",
    outOfStockAsk: "Nicht vorrätig — fragen Sie uns nach der nächsten Produktion",
    addBoxShort: "Hinzufügen · {total}",
    etaLargeOrders: "Sehr große Bestellungen können länger dauern — den Termin bestätigen wir auf der Rechnung.",
    madeForYou: "Für Ihre Bestellung gefertigt",
    boxesLabel: "Kartons",
    addBoxesSummary: "{boxes} × {pairs} Paar hinzufügen · {total}",
    addedViewCart: "Zum Warenkorb hinzugefügt.",
    viewCart: "Warenkorb ansehen",
    listPriceLabel: "Liste {price}",
    vatForGreece: "+MwSt. (GR)",
    noVatAbroad: "Ohne MwSt.",
    inStockBoxes: "{count} Kartons vorrätig — Versand in 5 Tagen",
    meterPairs: "{count} von {min} Paar",
    meterPairsDone: "{count} Paar",
    modelColours: "In {count} Farben erhältlich",
    meterToGo: "noch {short}",
    meterReady: "Bereit zum Senden ✓",
    meterAria: "Mindestbestellung: {count} von {min} Paar. Warenkorb öffnen.",
  },
  checkout: {
    ...
    notesPlaceholder: "Gewünschter Spediteur, Lieferhinweise, alles, was wir wissen sollten…",
    estimatedShipping: "Lieferung & Versand",
    ...
    submitOrder: "Proforma anfordern",
    submitting: "Wird gesendet…",
    ...
    madeToOrderBody: "für Ihre Bestellung gefertigt — Lieferung in etwa {days} Tagen nach Bestätigung.",
    preOrderLabel: "Vorbestellung ({count} Modelle):",
    preOrderBody: "für Ihre Bestellung gefertigt — Lieferung in etwa {days} Tagen nach Bestätigung. Sehr große Bestellungen können länger dauern; den Termin bestätigen wir auf Ihrer Rechnung.",
    shippingNote: "Der Versand geht zu Ihren Lasten, mit einem Spediteur Ihrer Wahl — wir fragen nach, sobald Ihre Bestellung fertig ist.",
    nextSteps: "Das ist keine Belastung. Wir prüfen die Produktion für genau diese Mengen und senden Ihnen dann die Rechnung mit Endpreis, Liefertermin und Zahlungsdaten — meist innerhalb eines Werktags. Die Anfrage erscheint sofort in Ihrer Bestellhistorie.",
  },
  auth: {
  ...
  product: {
    ...
    materials: "Materialien",
    weight: "Gewicht",
    weightValue: "Etwa {weight} pro Paar",
    msrp: "UVP",
    ...
    prebookValue: "Vorbestellung — Lieferung in etwa {days} Tagen",
    prebookValueWithWindow: "Vorbestellung — Versand {window}",
    madeToOrderValue: "Auf Bestellung — Lieferung in etwa {days} Tagen",
    paymentTerms: "Zahlungsbedingungen",
    pricingShown: "Angezeigte Preise",
    pricingShownValue: "Ohne MwSt. — griechische MwSt. ({rate} %) nur für Käufer mit Sitz in Griechenland",
  ...
  tax: {
    ...
    vatSuffix: "+MwSt.",
    vatNotCharged: "Alle Preise sind Großhandelspreise. Es wird keine griechische MwSt. berechnet — Ihr Unternehmen hat seinen Sitz außerhalb Griechenlands.",
    vatLabel: "MwSt. ({rate}%)",
  ...
  seo: {
    ...
    homeDescription:
      "Hersteller und Großhändler für Herren-Lederschuhe seit 1984 — Loafer, Stiefel, elegante Schuhe und Sneaker aus Vollnarbenleder. Bestellung im Karton.",
    ...
    brandStoryTitle: "Über uns — Hersteller von Herren-Lederschuhen seit 1984",
  ...
  contact: {
    ...
    whatsappAria: "Fragen Sie uns per WhatsApp",
    whatsappMessage: "Hallo Hector Footwear, ich habe eine Frage:",
    whatsappProductMessage: "Hallo Hector Footwear, eine Frage zu {name}:",
    whatsappLabel: "WhatsApp {number}",
    phoneLabel: "Telefon {number}",
    whatsappFastest: "Am schnellsten erreichen Sie uns per WhatsApp — meist antworten wir am selben Tag.",
  },
  faq: {
  ...
  home: {
    ...
    feature3Title: "Für Ihre Bestellung gefertigt",
    feature3Body: "Jede Bestellung wird für Sie produziert, und jedes Modell kann in jeder Saison gefertigt werden — auch Stiefel im Juli.",
    ...
    welcomeBody: "Jede Bestellung wird für Sie gefertigt und kommt bei Bestellung heute um den {date} an.",
    lastOrder: "Ihre letzte Bestellung",
    viewOrder: "Bestellung ansehen",
    openOrderSheet: "Bestellliste",
    browseCatalogue: "Katalog",
    noOrdersYetHome: "Noch keine Bestellung — mit der Bestellliste geht die erste am schnellsten.",
    howEyebrow: "Für Händler",
    howHeading: "So bestellen Sie",
    howStep1Title: "Antrag",
    howStep1Body: "Zwei Minuten: Ihr Geschäft, Ihre USt-IdNr., wie wir Sie erreichen.",
    howStep2Title: "Freigabe",
    howStep2Body: "Ein Mensch prüft ihn, meist innerhalb von 2 Werktagen. Dann sehen Sie Ihre Preise.",
    howStep3Title: "Online bestellen",
    howStep3Body: "Kartonweise, ab 40 Paar, beliebig über Modelle und Farben gemischt.",
    howStep4Title: "Rechnung & Zahlung",
    howStep4Body: "Innerhalb eines Werktags: Endpreis, Liefertermin und Zahlungsdaten.",
    howStep5Title: "Für Sie gefertigt",
    howStep5Body: "In etwa {days} Tagen fertig und an Ihren Spediteur übergeben.",
    factMinimum: "Ab 40 Paar, gemischt",
    factBoxes: "Kartons à 8 oder 10 Paar",
