const en = {
  ...
  email: {
    ...
    seasonSubject: "New styles — order by {orderBy} for delivery around {deliveredBy}",
    seasonIntro: "Our newest styles are in the catalogue and ready to order:",
    seasonDeadline: "Order by {orderBy} and your boxes will be ready around {deliveredBy}.",
    seasonCtaNew: "See the new styles",
    seasonCtaSheet: "Open the order sheet",
  ...
  home: {
    ...
    howEyebrow: "For shops",
    howHeading: "How ordering works",
    howStep1Title: "Apply",
    howStep1Body: "Two minutes: your shop, your VAT number, how to reach you.",
    howStep2Title: "Approved",
    howStep2Body: "A person checks it, usually within 2 business days. Then you see your prices.",
    howStep3Title: "Order online",
    howStep3Body: "By the box, from 40 pairs mixed across any styles and colours.",
    howStep4Title: "Invoice & payment",
    howStep4Body: "Within a business day: final price, delivery date and payment details.",
    howStep5Title: "Made for you",
    howStep5Body: "Ready in about {days} days and handed to your own courier.",
    factMinimum: "40 pairs minimum, mixed",
    factBoxes: "Boxes of 8 or 10 pairs",
