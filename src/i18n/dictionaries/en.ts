const en = {
  ...
  orderDetail: {
    title: "Order Detail",
    dashboard: "Dashboard",
    proformaNotice: "Proforma invoice generated — this isn’t a charge. {rep} will confirm stock and production before it proceeds.",
  ...
  apply: {
    ...
    intro:
      "We review every application manually — typically within 2 business days. You’ll need your resale certificate or tax ID on hand. Approved accounts get immediate access to full pricing, matrix ordering, and the digital linesheet.",
    legendBusiness: "Business",
    legendLocation: "Store Location",
    legendContact: "Contact",
    businessName: "Business name *",
    website: "Website",
    businessType: "Business type *",
    expectedVolume: "Expected annual volume *",
    resaleCert: "Resale certificate / Tax ID *",
    resaleCertPlaceholder: "e.g. EL123456789",
    ...
    storeLocation: "City, region (as shown publicly) *",
    storeLocationPlaceholder: "Athens, Attica",
  ...
  catalog: {
    ...
    publicPanelBody: "Trade pricing, box quantities and live stock are available to approved wholesale accounts. Applications are reviewed manually, usually within two business days.",
