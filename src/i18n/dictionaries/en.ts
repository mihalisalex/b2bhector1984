const en = {
  ...
  dashboard: {
    ...
    quickOrderIntro: "The full collection at list price — press + or − on any box size to add it straight to your cart. Payment terms (and any discount) are set at checkout.",
    remove: "Remove",
