...
const fr: Dictionary = {
  ...
  orderDetail: {
    ...
    proformaNotice: "Facture proforma générée — il ne s’agit pas d’un débit. {rep} confirmera le stock et la production avant de poursuivre.",
  ...
  apply: {
    ...
    storeLocation: "Ville, région (affichage public) *",
    storeLocationPlaceholder: "Paris, Île-de-France",
  ...
  catalog: {
    ...
    publicPanelBody: "Les tarifs de gros, les quantités par carton et le stock en direct sont réservés aux comptes professionnels validés. Les demandes sont examinées manuellement, généralement sous deux jours ouvrés.",
