...
const fr: Dictionary = {
  ...
  dashboard: {
    ...
    quickOrderIntro: "La collection complète au prix catalogue — appuyez sur + ou − sur une taille de carton pour l’ajouter directement au panier. Les conditions de paiement (et toute remise) sont définies au moment de la commande.",
    remove: "Retirer",
