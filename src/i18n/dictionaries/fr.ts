...
const fr: Dictionary = {
  ...
  pdf: {
    ...
    statusShipped: "Remise au transporteur",
  ...
  email: {
    ...
    statusBodyConfirmed: "Votre commande {id} est confirmée. La facture avec le prix final, la date de livraison et les coordonnées de paiement arrive.",
    statusBodyInProduction: "Votre commande {id} est en production. Nous prévoyons qu’elle soit prête vers le {date}.",
    statusBodyShipped: "Votre commande {id} est prête et a été remise à votre transporteur.",
    statusBodyDelivered: "Votre commande {id} a été livrée. Merci — bonnes ventes !",
    statusBodyCancelled: "Votre commande {id} a été annulée. Des questions ? Répondez à cet e-mail ou écrivez-nous sur WhatsApp.",
    viewOrderLine: "Voir votre commande : {link}",
    ...
    inviteSubject: "Votre compte professionnel Hector Footwear est prêt",
    inviteBody: "Nous avons créé un compte professionnel pour {business} sur notre nouveau site de commande. Définissez votre mot de passe avec le lien ci-dessous pour voir vos prix et commander quand vous voulez — au carton, depuis votre téléphone ou ordinateur.",
    inviteWhatsapp: "Bonjour {name}, nous avons créé un compte professionnel pour {business} sur notre nouveau site. Définissez votre mot de passe ici pour voir vos prix et commander en ligne : {link} — Hector Footwear",
    seasonSubject: "Nouveaux modèles — commandez avant le {orderBy}, livraison vers le {deliveredBy}",
    seasonIntro: "Nos derniers modèles sont au catalogue et disponibles à la commande :",
    seasonDeadline: "Commandez avant le {orderBy} et vos cartons seront prêts vers le {deliveredBy}.",
    seasonCtaNew: "Voir les nouveautés",
    seasonCtaSheet: "Ouvrir la feuille de commande",
  ...
  home: {
    ...
    howEyebrow: "Pour les boutiques",
    howHeading: "Comment commander",
    howStep1Title: "Demande",
    howStep1Body: "Deux minutes : votre boutique, votre n° de TVA, comment vous joindre.",
    howStep2Title: "Validation",
    howStep2Body: "Une personne la vérifie, en général sous 2 jours ouvrés. Vous voyez alors vos prix.",
    howStep3Title: "Commande en ligne",
    howStep3Body: "Au carton, dès 40 paires mélangées entre modèles et coloris.",
    howStep4Title: "Facture & paiement",
    howStep4Body: "Sous un jour ouvré : prix final, date de livraison et paiement.",
    howStep5Title: "Fabriqué pour vous",
    howStep5Body: "Prêt en environ {days} jours et remis à votre transporteur.",
    factMinimum: "40 paires minimum, mélangées",
    factBoxes: "Cartons de 8 ou 10 paires",
